...
- ✅ მულტილიბილინგვალური embeddings (Georgian support)
...
- **დემო:** [დაამატეთ Streamlit Cloud / Hugging Face Spaces ლინკი]

დემოს გასაშვებად Streamlit Cloud-ზე ან Hugging Face Spaces-ზე:
1. ატვირთეთ რეპოზიტორი GitHub-ზე
2. შექმენით ახალი Streamlit Cloud აპლიკაცია
3. დააკავშირეთ GitHub რეპოზიტორი
4. დაამატეთ `OPENAI_API_KEY` Secrets-ში
