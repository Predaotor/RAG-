...
- ✅ მულტილინგვალური embeddings (Georgian support)
...
- **GitHub:** [დაამატეთ თქვენი რეპოზიტორის ლინკი]
- **დემო:** [დაამატეთ Streamlit Cloud ლინკი]

### დემოს გამოქვეყნება (Streamlit Community Cloud – უფასო)

1. ატვირთეთ რეპოზიტორი GitHub-ზე
2. გადადით [share.streamlit.io](https://share.streamlit.io)
3. დააჭირეთ "New app" → აირჩიეთ რეპოზიტორი და `src/app.py`
4. Secrets → დაამატეთ `OPENAI_API_KEY` = `your-api-key`
5. Deploy → მიიღებთ ლინკს მაგ. `https://your-app.streamlit.app`

**Docker არ არის საჭირო** – Streamlit Cloud ავტომატურად აყენებს დამოკიდებულებებს. Docker გამოიყენება მხოლოდ თუ თქვენს ინფრასტრუქტურაზე deployment გჭირდებათ.
